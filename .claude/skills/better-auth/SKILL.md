...
For deeper guidance, read the relevant file alongside this one:

| File | When to use |
|------|------------|
| `best-practices.md` | Configuring `auth.ts`, adapters, sessions, gotchas |
| `emailAndPassword.md` | Email verification, password reset, hashing |
| `organization.md` | Multi-tenant orgs, members, roles, invitations |
| `twoFactor.md` | TOTP, OTP, backup codes, trusted devices |
| `security.md` | Rate limiting, CSRF, cookies, secrets, auditing |
